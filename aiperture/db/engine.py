...
def _import_all_models():
    ...
    import aiperture.models.artifact  # noqa: F401
    import aiperture.models.audit  # noqa: F401
    import aiperture.models.intelligence  # noqa: F401
    import aiperture.models.permission  # noqa: F401
...
def get_engine():
    ...
    # Delegate to plugin database engine factory if present
    db_factory = plugins.get("db_engine")
    if db_factory is not None:
        _engine = db_factory.create_engine(aiperture.config.settings)
        return _engine
